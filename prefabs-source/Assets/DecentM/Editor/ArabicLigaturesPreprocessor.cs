...
namespace DecentM.EditorTools
{
    public static class ArabicText
    {
        ...
        private static Dictionary<int, int[]> charStorage = new Dictionary<int, int[]>()
        {
        ...
        private static Dictionary<int, int[]> boolStorage = new Dictionary<int, int[]>()
        {
            { 65165, new int[] { 0, 1 } },
            { 65167, new int[] { 1, 1 } },
            { 64342, new int[] { 1, 1 } },
        ...
        private static string FaConvertLine(string input)
        {
            ...
            for (int i = 0; i < charTemp.Length; i++)
            {
                ...
                {
                    chT = ConvertChar(
                        (i == 0) ? 0 : Convert.ToInt32(charTemp[i - 1]),
